...
function ProjectCardFuncGrid({ setDontShowRevision, project, setUpdateTime = () => { } }) {
    ...
    if (role === "project_manager"||role==="creative_director") {
        return (
            <>
                <div className="flex flex-col flex-1 justify-end items-end my-auto w-8">
                    <span onClick={() => handleRouteLocation(`/files/${project._id}`)}>
                        <FileGreyIcon className="h-8 w-8 text-secondary-gray cursor-pointer" />
                    </span>
    ...
    return (
        <>
            ...
            <div className="flex flex-col flex-1 justify-end items-end my-auto w-fit">
...
export default ProjectCardFuncGrid